// Создание кода T4 для модели "D:\work_in_avia_college\4 курс\внедрение и поддержка компьютерных систем\интеграция(последняя работа)\WpfApp1\models\Model1.edmx" включено. 
